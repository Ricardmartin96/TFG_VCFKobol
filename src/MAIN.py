...
labels=['16F', '32F', '64F', '128F', '256F', '512F', '1024F', '2048F', '4096F', '8102']
...
for i in range(0,len(IR_output_res_list)-1):
    TF_mag_out_res, TF_ang_out_res = transfer_function( IR_input,
                                                        IR_output_res_list[i])

    TF_mag_out_res = TF_mag_out_res - mean(TF_mag_out_res[20:45])
    f1, f2, fcentral, fres, peak, Q = resonance(sr, TF_mag_out_res, TF_mag_ref,
